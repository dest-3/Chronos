...
def generate_c_header(json_data, header_filename, source_filename):
    ...
    edr_sec_event_structs_size = 8 * 5
    meta_buf_size = 45
    ...
    if (ret_addr_check):
        fixed_ro_struct_size = 4 * 3
        yield_arr_size = 4 * max_yield_addresses * 4
...
def main():
    json_input = '''{
        ...
        "TIME_CHECK_TICK_FREQ": 3000,
        "HBEAT_TICK_FREQ": 6000,
        "CONCRETE_EXEC_TIMES_ARRAY_LEN": 8,
        ...
        "FULL_EXEC_CHECK": 0,
        "tasks": [
            {"id": 0, "averageExecutionTime": 143, "worstCaseExecutionTime": 150, "maximumAverageDeviation": 50, "vTaskDelay_LR": [150332], "vTaskDelayUntil_LR": [0], "taskYIELD_FROM_TASK": [0], "vTaskSuspend":[0]},
            {"id": 1, "averageExecutionTime": 293, "worstCaseExecutionTime": 395, "maximumAverageDeviation": 60, "vTaskDelay_LR": [150544], "vTaskDelayUntil_LR": [0], "taskYIELD_FROM_TASK": [0], "vTaskSuspend":[0]},
            {"id": 2, "averageExecutionTime": 415, "worstCaseExecutionTime": 578, "maximumAverageDeviation": 80, "vTaskDelay_LR": [150744], "vTaskDelayUntil_LR": [0], "taskYIELD_FROM_TASK": [0], "vTaskSuspend":[0]},
            {"id": 3, "averageExecutionTime": 171, "worstCaseExecutionTime": 189, "maximumAverageDeviation": 50, "vTaskDelay_LR": [150888], "vTaskDelayUntil_LR": [0], "taskYIELD_FROM_TASK": [150880], "vTaskSuspend":[0]}
        ]
    }'''
