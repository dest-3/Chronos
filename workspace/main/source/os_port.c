...
/* USER CODE END */
        ...
        if( usStackDepth > 0 )
        {
            ...
            xMPUSettings->xRegion[0].ulRegionAttribute   = portMPU_REGION_READ_WRITE | portMPU_NORMAL_OIWTNOWA_SHARED | portMPU_REGION_EXECUTE_NEVER;
...
static void prvSetupDefaultMPU( void )
{
    ...
    placed. */
    prvMpuSetRegion(portPRIVILEGED_FLASH_REGION,  0x00000000, portMPU_SIZE_128KB | portMPU_REGION_ENABLE, portMPU_PRIV_RO_USER_NA_EXEC | portMPU_NORMAL_OIWTNOWA_SHARED);

    /* Setup the the entire RAM region for privileged read-write and unprivileged read only access */
    prvMpuSetRegion(portPRIVILEGED_RAM_REGION,  0x08000000, portMPU_SIZE_512KB | portMPU_REGION_ENABLE, portMPU_PRIV_RW_USER_NA_NOEXEC | portMPU_NORMAL_OIWTNOWA_SHARED);
    ...
    prvMpuSetRegion(portGENERAL_PERIPHERALS_REGION,  0xF0000000,
                    ...
                    portMPU_PRIV_RW_USER_RO_NOEXEC | portMPU_DEVICE_NONSHAREABLE);
    ...
    /* EDR REGION */
    prvMpuSetRegion(portPRIVILEGED_EDR_REGION,  0x0803F800 + 0x200, EDR_RW_MPU_SECT_SIZE | portMPU_REGION_ENABLE, portMPU_PRIV_RW_USER_NA_NOEXEC | portMPU_DEVICE_NONSHAREABLE);

    /* EDR READ-ONLY REGION */
    prvMpuSetRegion(portPRIVILEGED_RO_EDR_REGION, 0x0803F800, EDR_RO_MPU_SECT_SIZE | portMPU_REGION_ENABLE, portMPU_PRIV_RO_USER_NA_NOEXEC | portMPU_DEVICE_NONSHAREABLE);
...
static void prvSetupTimerInterrupt(void)
{
    ...
    /* Disable all RTI timers. */
      ...
      /* Enable RTI timers. */
      portRTI_GCTRL_REG |= 0x00000001U; // Enable OS timer
