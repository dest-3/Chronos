...
// Uncomment one of these to enable a specific test case
// #define TEST_CASE_CODE_INJ_STACK_EXEC      - [YES] tested
// #define TEST_CASE_CODE_INJ_ROP_EXCEED_WCET - [YES] tested
// #define TEST_CASE_CODE_INJ_ROP_BELOW_WCET  - [YES] tested
// #define TEST_CASE_CODE_INJ_ROP_STOP_TIMER  - [YES] 
// #define TEST_CASE_VERIFY_MPU_REGIONS       - [YES]
// #define TEST_CASE_PRIV_ROP_GADGET          - [YES] tested
// #define TEST_CASE_RW_EDR_STATE             - [YES] tested
// #define TEST_CASE_TASK_CREATION            - [YES] tested
// #define TEST_CASE_NEVER_YIELD              - [YES]
// #define TEST_CASE_MODIFY_MPU_CONF          - [YES]
// #define TEST_CASE_EDR_TASK_INTERFER        - [YES] tested
// #define TEST_CASE_EMAC_INTERFER            - [YES] needs more testing + more techniques?
// #define TEST_CASE_WDOG_INTERFER            - [YES] tested
// #define TEST_CASE_LWIP_INTERFER            - [NO]
// #define TEST_CASE_CODE_INJ_ROP_LR_CHECK    - [YES] tested
// #define TEST_CASE_RESTR_TASK_ACCESS_STACK  - [YES] tested
...
// =============================
//   TEST_CASE_LWIP_INTERFER
// =============================

void TEST_CASE_LWIP_INTERFER() { 
    // try to modify entry of TX interrupt in vector interrupt table

    // perhaps try to get a reference to and modify another LWIP data structure? 
}
