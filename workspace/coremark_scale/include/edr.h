...
EDR_DATA static edr_meta edr_meta_gbl = {
    .meta_arr = {
        ...
        {0, 0, 0, {0}, 0, 0, 0, 0, 0}, // Task 4
    },
    .edr_sleep_time = 0,
    .edr_t_handle = 0
};

EDR_RO_DATA static task_tm_conf task_conf_array[5] = {
        {
